...
<?php  if  (!empty($_SESSION['id']))  :  ?>
                  ...
                  <div  class="row">
                        ...
                        <div  class="col-md-4">
                              ...
                              <div  class="alert  alert-info"  role="alert">
                                    Anda  maksimal  bisa  meminjam  buku  selama  <strong>10  Hari</strong>,  dari  tanggal  pinjam.
                              </div>
                        </div>
                  </div>
            </div>
      <?php  endif;  ?>
      <?php  else:  ?>
            <?php  echo  "<script>alert('Silahkan  Login  Dulu.');window.location='page/auth/login.php';</script>";  ?>
<?php  endif;  ?>
